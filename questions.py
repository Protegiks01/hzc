...
questions_generator  = [
    ...
    "x/dex/types/message_create_pool.go",
    ...
    "x/factory/keeper/query_denom.go",
    "x/factory/keeper/query_denom_auth.go",
    "x/factory/keeper/query_denom_by_admin.go",
    "x/factory/keeper/msg_create_denom.go",
    "x/factory/keeper/msg_mint_and_send_tokens.go",
    "x/factory/keeper/msg_burn_tokens.go",
    "x/factory/keeper/msg_propose_denom_admin.go",
    "x/factory/keeper/msg_claim_denom_admin.go",
    "x/factory/keeper/msg_update_denom_metadata_auth.go",
    "x/factory/keeper/msg_update_denom_uri.go",
    "x/factory/keeper/msg_update_denom_minting_cap.go",
    ...
    "x/factory/types/message_create_denom.go",
    "x/factory/types/message_mint_and_send_tokens.go",
    "x/factory/types/message_burn_tokens.go",
    ...
    "x/factory/types/message_update_params.go",
    "x/factory/types/utils.go",

    # Factory Module - Other
    "x/factory/module/genesis.go",
    "x/factory/module/module.go",
    "x/factory/events/emit.go",
    "x/factory/migrations/new_migrator.go",
    "x/factory/client/cli/tx.go",
    "x/factory/client/cli/query.go",

    # TokenWrapper Module - Core
    ...
    "x/tokenwrapper/keeper/state.go",
    "x/tokenwrapper/keeper/token_operations.go",
    "x/tokenwrapper/keeper/msg_server_update_params.go",
    ...
    "x/tokenwrapper/types/message_pause.go",
    "x/tokenwrapper/types/message_unpause. go",
    "x/tokenwrapper/types/message_recover_zig.go",
    "x/tokenwrapper/types/message_update_ibc_settings.go",

    # TokenWrapper Module - IBC
    ...
    "x/tokenwrapper/module/on_acknowledgement_packet.go",
    ...
    "zutils/constants/constants.go",
    "zutils/validators/validators.go",

    # Documentation/Docs (may contain API definitions)
    "docs/docs.go",
]
